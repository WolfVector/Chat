        ...
        <div class='m-auto text-white'>
            ...
            <div class='bg-gray-800 m-auto w-96 px-3 py-3 rounded'>
                <form action='/register' method='post'>
                    @csrf
                    <input type='text' name='name' placeholder='Name' class='bg-gray-900 mb-3 rounded w-80 placeholder-gray-500 px-1 py-1'>
                    <input type='text' name='username' placeholder='User name' class='bg-gray-900 mb-3 rounded w-80 placeholder-gray-500 px-1 py-1'>
                    <input type='email' name='email' placeholder='Email' class='bg-gray-900 mb-3 rounded w-80 placeholder-gray-500 px-1 py-1'>
                    ...
                    <input type='password' name='password_confirmation' placeholder='Password confirmation' class='bg-gray-900 mb-3 rounded w-80 placeholder-gray-500 px-1 py-1'>
                    <input type='submit' value='Register' class='rounded mb-3 bg-white px-1 py-2 text-black hover:bg-blue-300'>
                    <br>
                    <a href='/login' class='text-blue-300 hover:underline'>Are you already register? Sign in</a>
                </form>
            </div>
